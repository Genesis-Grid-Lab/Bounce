...
namespace Engine {
    ...
    void Mesh::setupMesh(){
        ...
        m_VertexArray = Factory::Create();
        
        Ref<VertexBuffer> vertexBuffer = Factory::Create(m_Vertices.data(), m_Vertices.size() * sizeof(Vertex));
        ...
        Ref<IndexBuffer> indexBuffer = Factory::Create(m_Indices.data(), m_Indices.size());
