...
namespace Engine {
  ...
  // ---------- static bootstrap ----------
  std::atomic<int> JoltPhysicsEngine::s_joltInits{0};

  void JoltPhysicsEngine::InitJoltOnce() {
  ...
  void JoltPhysicsEngine::ShutdownJoltOnce() {
  ...
  JoltPhysicsEngine::~JoltPhysicsEngine() { Shutdown();}
  ...
  bool JoltPhysicsEngine::Step(float dt){
